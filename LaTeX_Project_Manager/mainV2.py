...
source_path = "C:\\Users\\NIC\\Documents\\GitHub\\latex_and_project\\LaTeX_Project_Manager\\source_TeX" # Dossier où sont stockés les fichiers sources TeX --> USER INPUT
standard_classe = [
    "book",
    "article",
    "report",
...
#create_project("test","article",images=False)
#remove_project("test")
